...
{
    public class SelectedResponseToVisibilityConverter : IMultiValueConverter
    {
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            // If there is an alert, the alert isn't triggered by current user and the user is listed as a Responder, return visible
